...
function Meta({ title, keywords, description }) {
  return (
    <Head>
      ...
      <meta content="divear.me - Lukáš Odehnal" property="og:title" />
      ...
      <meta content="Divear's personal site" property="og:description" />{" "}
      <meta content="#0a647c" data-react-helmet="true" name="theme-color" />
      <meta content="#0a647c" data-react-helmet="true" name="theme_color" />
      <meta
        content="#022129"
      ...
      <meta name="twitter:description" content="Divear's personal site" />
